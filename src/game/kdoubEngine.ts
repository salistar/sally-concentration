/**
 * ConcentrationEngine - Moteur de jeu Concentration marocain
 ...
 *   est rompue par un "Concentration!" (contestation) ou quand tout le monde passe
 *   sans contester (alors le joueur suivant peut recommencer avec une nouvelle
 *   valeur — cela clôt la séquence précédente).
 * - N'importe quel autre joueur peut crier "Concentration!" pour contester
...
export type GamePhase =
  ...
  | 'challenging'  // Fenêtre de contestation "Concentration!"
...
/** Résoudre un défi "Concentration!" */
...
export function gameReducer(state: GameState, action: GameAction): GameState {
  switch (action.type) {
    ...
    case 'PLAY_CARD': {
      ...
      // poser une carte (= renoncer à crier Concentration) OU appuyer sur Concentration.
      ...
      // Seule une contestation Concentration! ou un nouveau round peut rompre la
