...
> Jeu de mémoire (Concentration) — paires de cartes, 3 difficultés.

[![Build APK](https://github.com/salistar/sally-concentration/actions/workflows/android-build.yml/badge.svg)](https://github.com/salistar/sally-concentration/actions/workflows/android-build.yml)
[![Lint & Test](https://github.com/salistar/sally-concentration/actions/workflows/lint-and-test.yml/badge.svg)](https://github.com/salistar/sally-concentration/actions/workflows/lint-and-test.yml)

App mobile faisant partie de la suite **SallyCards** — Expo SDK 52, React Native 0.76, Hermes, expo-router.

| | |
|---|---|
| **Bundle ID Android** | `com.sallycards.concentration` |
| **Bundle ID iOS** | `com.sallycards.concentration` |
| **Couleur thème** | `#DB2777` |
...
- 3 niveaux : facile (12 cartes), normal (20), expert (30)
- Thèmes : animaux, fruits, drapeaux, cartes classiques
- Mode duel local (2 joueurs sur le même téléphone, tour par tour)
- Chrono + score + record personnel par niveau
- Pas de multi-joueur en ligne (solo / hot-seat)
- 5 langues
...
```powershell
git clone https://github.com/salistar/sally-concentration.git
cd sally-concentration
npm install
npx expo start
...
subst Y: C:\Users\$env:USERNAME\Desktop\sally-concentration
cd Y:\
...
# Install + launch
adb uninstall com.sallycards.concentration 2>$null
adb install -r app\build\outputs\apk\debug\app-debug.apk
adb shell am start -n com.sallycards.concentration/.MainActivity
...
keytool -genkeypair -v -storetype PKCS12 `
  -keystore concentration.keystore -alias concentration `
  -keyalg RSA -keysize 2048 -validity 10000

# 2) Configurer android/gradle.properties
@"
CONCENTRATION_UPLOAD_STORE_FILE=concentration.keystore
CONCENTRATION_UPLOAD_KEY_ALIAS=concentration
CONCENTRATION_UPLOAD_STORE_PASSWORD=<password>
CONCENTRATION_UPLOAD_KEY_PASSWORD=<password>
...
# ou via Xcode :
open ios/concentration.xcworkspace
```
